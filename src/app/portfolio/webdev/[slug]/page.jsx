...
export default function WebDevCaseStudyPage({ params }) {
  ...
  return (
    <ScrollWrapper>
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#E8F3FA] to-[#F7FAFD] relative">

        {/* Back Button */}
        <div className="fixed top-24 left-6 z-50">
          <Link href="/portfolio/webdev">
            <div className="p-3 bg-white/90 rounded-full shadow-lg transform transition-transform duration-300 hover:scale-110 hover:bg-blue-600 hover:shadow-xl">
              <span className="text-blue-800 text-2xl font-bold hover:text-white transition">←</span>
            </div>
          </Link>
        </div>
        ...
        <main className="flex-grow pt-32 px-6 pb-20">
          <div className="text-center mb-16">
            <p className="text-sm text-gray-600 mb-3">Web Development Case Study</p>
            <h1 className="text-[42px] md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1D9BF0] to-[#00D4FF]">{project.title}</h1>
