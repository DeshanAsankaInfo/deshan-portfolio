      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#E9F8FA] to-[#F5FBFF]">
        ...
        <main className="flex-grow pt-32 px-6 pb-20">
          <div className="text-center mb-10">
            ...
            <h1 className="text-[40px] md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0085FF] to-[#00FFD1]" style={{ fontFamily: 'Otterco Display, sans-serif' }}>
          ...
          <div className="flex flex-wrap justify-center gap-10">
            {webdevProjects.map((project) => (
              <Link
                href={`/portfolio/webdev/${project.slug}`}
                key={project.id}
...
<div className="mt-28">
  ...
  <div className="flex flex-wrap justify-center gap-8">
    {allProjects
      .filter(p => p.slug !== 'webdev') // Exclude current
      .map((project, idx) => (
        <Link
          key={idx}
